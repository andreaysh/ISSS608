...
::: callout-note
To refer to [here](https://www.datanovia.com/en/blog/ggplot-point-shapes-best-tips/) for `ggplot()` `geom_point()` shapes best tips and tricks
:::
...
By defaultm the bar charts in ggplot2 are vertical, as shown:
...
Themes in graphing control non-data elements such as - background color - fonts size - gridlines - labels color

Built-in themes include: - `theme_gray()`: default theme, with a light gray background and white gridlines.
