...
After considering various approaches, we chose to implement both map types as they serve different purposes:
...
server <- function(input, output, session) {
  ...
  # Update country list based on filtered data
  observe({
...
server <- function(input, output, session) {
  ...
  output$choropleth_map <- renderTmap({
    ...
    # Try zooming if country is selected
