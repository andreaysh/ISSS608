...
+-----------------+-------------------------------------------------------------------------------------------------------+
| Lifestyle       | Smoking_History, Alcohol_Consumption, Physical_Activity, Diet_Quality, Stress_Levels                  |
+-----------------+-------------------------------------------------------------------------------------------------------+
...
#### 4.3.2 Does health factor plays a role in contributing to heart attack incidents

We will perform a similar analysis on Region to identify if it plays a significant role in contributing to heart attack incidents.
